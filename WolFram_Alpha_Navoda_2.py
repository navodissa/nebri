...
class wolfram(object):
	...
	def check(self, resp):
		return search(self.resp) >= self.threshold_revenue

	def action(self, resp):
		send_email (self.my_email,
		""" Revenue of company Google is now {} billions of US dollars
		""".format(search(self.resp))
		)
